	...
	var methods = {
		init : function() {
			...
			return this.each( function() {
				...
				var $textarea = $(this).css({'resize': 'none', overflow: 'hidden', height: '20px'});
				...
				$textarea.bind('keyup change cut paste', function(){
					// Custom Change: added next 4 lines for setting width of cloned div equal to width of textarea
